function Init (){
    var operation = document.getElementsByClassName("item0");
    var atras = document.getElementsByClassName("item1");
    ...
    var one = document.getElementsByClassName("item9");
    var zero = document.getElementsByClassName("item10");
    var rest = document.getElementsByClassName("item11");
    var divid = document.getElementsByClassName("item12");
